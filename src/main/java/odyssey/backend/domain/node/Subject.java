...
public enum Subject {
    ...
    MATH_AND_AI("수학과 인공지능", "인공지능 알고리즘에 적용되는 수학적 원리 구현 및 이해"),
    AI_PROGRAMMING("인공지능 프로그래밍", "데이터 수집 및 분석, 생성형 인공지능 활용"),
    SCREEN_IMPLEMENTATION("화면구현", "HTML, CSS, JS를 이용한 화면 구현"),
    ADVANCED_SCREEN_IMPLEMENTATION("응용프로그래밍 화면구현", "졸업작품 UX/UI 디자인, 프로젝트 화면 구현 심화"),
    APPLICATION_PROGRAMMING("응용프로그래밍", "FastAPI 백엔드 + Jinja 템플릿"),
    WEB_PROGRAMMING("웹프로그래밍", "React, Socket.io 활용 프론트엔드 수업"),
    WEB_PROGRAMMING_PRACTICE("웹프로그래밍 실무", "Next.js 기반 포트폴리오용 프로젝트"),
    FRONTEND_BASIC("프론트엔드 기초", "React, Next.js, Socket.io 기반 프로젝트 실습"),
    SQL("SQL활용", "데이터베이스 쿼리 실습"),
    APPLICATION_DEV("응용프로그래밍개발", "FastAPI 활용 백엔드 API 개발"),
    DATABASE_PROGRAMMING("데이터베이스프로그래밍", "MySQL 기반 SQL 쿼리 학습, 데이터베이스 기초 지식"),
    JAVA_PROGRAMMING("JAVA프로그래밍", "Spring Boot 기반 백엔드 API 개발"),
    PROGRAMMING("프로그래밍", "Python 기초 문법 및 문제 해결"),
    NETWORK_PROGRAMMING("네트워크 프로그래밍", "라즈베리파이를 활용한 웹 서버"),
    AWS_BASIC("AWS 기초 입문 실전", "EC2, 로드밸런서, RDS, S3, 구축"),
    ...
    MOTION_GRAPHIC("모션 그래픽", "Phase, After Effects, Premiere 활용 영상 모션 애니메이션"),
